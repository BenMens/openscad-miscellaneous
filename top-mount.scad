...
module groundPlate () {
	...
	union() {
		...
		translate([17, 9, -boolOpOffset1]) 
            cylinder(thickness + boolOpOffset2, 5.5, 5.5);

		translate([16 + 17 + 4.5, 8, -boolOpOffset1]) 
            cylinder(thickness + boolOpOffset2, 5, 5);
		
		translate([24.5, 43 + 4.5, -boolOpOffset1]) 
            cylinder(thickness + boolOpOffset2, 1.6, 1.6);

		translate([24.5, 43 + 4.5, -2]) 
            cylinder(thickness + boolOpOffset2, 3, 3);

		translate([65 -4.5 - 4.5, 70, -boolOpOffset1]) 
            cylinder(thickness + boolOpOffset2, 1.6, 1.6);
	
		translate([65 -4.5 - 4.5, 70, -2]) 
            cylinder(thickness + boolOpOffset2, 3, 3);
...
translate([-4, -width/2, 0])
    cube([4, width, 12]);

translate([-14, -width/2, 0])
    cube([14, width, 2]);

difference() {
    translate([-155, -width/2 - 10, 0])
        cube([159, 20, 12]);    
